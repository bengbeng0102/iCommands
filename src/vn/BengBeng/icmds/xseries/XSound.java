package vn.BengBeng.icmds.xseries;
...
public enum XSound {
	...
	public static XSound matchXSound(@Nonnull Sound sound) {
		...
		return matchXSound(sound.name()).orElseThrow(() -> new IllegalArgumentException("Unsupported Sound: " + sound.name()));
	}
	...
	public static CompletableFuture<Void> playSoundFromString(@Nonnull Player player, @Nullable String sound) {
		...
		return CompletableFuture.runAsync(() -> {
			...
			String[] split = StringUtils.contains(sound, ',') ? StringUtils.split(StringUtils.deleteWhitespace(sound), ',') : StringUtils.split(sound.replaceAll("  +", " "), ' ');
